...
bl_info = \
    {
        ...
        "description" :
            "The idea is to make levels for my old game rollin... which isnt really rollin anymore, but it still has"
            "the original idea, of puzzle based levels. Physics based.",
        "warning" : "I dono...",
        "wiki_url" : "Grimfang/Lext",
        "tracker_url" : "",
        "category" : "Editor",
    }
#################
